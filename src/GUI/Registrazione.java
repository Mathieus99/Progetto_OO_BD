	...
	public Registrazione(Controller c, JFrame accesso, String ruolo){
		...
		btnRegistrazione.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!textFieldEmail.getText().contains("@studenti.unina.it") && !textFieldEmail.getText().contains("@unina.it") && !lblEmailError.getText().contentEquals("Inserisci l'email!")) {
		...
		btnRegistrazione.setBounds(46, 233, 308, 35);
		...
		JLabel lblNewLabel = new JLabel("*La password deve contenere dagli 8 ai 16 caratteri");
		lblNewLabel.setForeground(Color.BLACK);
		lblNewLabel.setBounds(46, 279, 398, 14);
		getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("**Inserire solo email \"@studenti.unina.it\" o \"@unina.it\"");
		lblNewLabel_1.setBounds(46, 295, 410, 14);
		...
		btnAnnulla.setBounds(395, 233, 125, 35);
