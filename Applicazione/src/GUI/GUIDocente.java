	...
	public GUIDocente(Controller c,JFrame accesso) {
		...
		lblCreaTestBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				JFrame frameCreaTest = new CreazioneTest(controller, frame);
				controller.creaTest();
				frame.setVisible(false);
		...
		JLabel lblCorreggiTestBtn = new JLabel("");
		lblCorreggiTestBtn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				SelectCorreggiTest Correzione = new SelectCorreggiTest(controller,frame);
				frame.setVisible(false);
				Correzione.setVisible(true);
			}
		});
		lblCorreggiTestBtn.setIcon(new ImageIcon(GUIDocente.class.getResource("/Immagini/ButtonDoTest.png")));
		lblCorreggiTestBtn.setBounds(370, 166, 150, 155);
		contentPane.add(lblCorreggiTestBtn);
		...
		lblVisualizzaTestBtn.setBounds(522, 149, 160, 192);
		contentPane.add(lblVisualizzaTestBtn);
		
		JLabel lblNewLabel = new JLabel("Visualizza Test");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel.setBounds(532, 330, 134, 29);
		contentPane.add(lblNewLabel);
		
		JLabel lblCorreggiTest_1 = new JLabel("Correggi Test");
		lblCorreggiTest_1.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblCorreggiTest_1.setBounds(380, 335, 118, 29);
		contentPane.add(lblCorreggiTest_1);
		/*-------------------------------------------------------------------------------------------------------------------------------------------------------*/
	}
}
