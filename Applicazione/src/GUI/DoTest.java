...
public class DoTest {
	...
	public void initialize() {
		...
		System.out.println("Controllo risposte della domanda : ");
		for (int i=0;i<5;i++)
		...
		if(c.getDomandeTest()[0].getTipo().contentEquals("Aperta")) {
			A.setVisible(false);
			B.setVisible(false);
			C.setVisible(false);
			D.setVisible(false);
		...
		} else if(c.getDomandeTest()[0].getTipo().contentEquals("Multipla")){
		...
		btnAvanti.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(c.getDomandeTest()[stato].getTipo().contentEquals("Aperta")) {
